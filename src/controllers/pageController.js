...
const home = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.creacteMenuObject)('all'),
        banner: {
...
const dogs = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.creacteMenuObject)('dog'),
        banner: {
            title: 'Cachorros',
...
const cats = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.creacteMenuObject)('cat'),
        banner: {
            title: 'Gatos',
...
const fishes = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.creacteMenuObject)('fish'),
        banner: {
            title: 'Peixes',
